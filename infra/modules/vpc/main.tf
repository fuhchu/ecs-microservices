...
# Placed here to break the circular dependency between the ecs and rds modules:
# rds needs this SG ID as input, and ecs also takes it as input.
# Neither module creates it — the vpc module owns it.
